...
제품명과 유통/소비기한이 보이게 바로 촬영해 냉장고 재료를 기록하고, 소비기한 캘린더와 요리 추천을 확인하는 Vercel 배포용 MVP입니다.
...
- 제품명과 유통/소비기한이 함께 보이는 라벨을 카메라로 바로 촬영
- 여러 제품을 한 장씩 계속 촬영해 목록에 누적
- 사진 파일 선택은 보조 옵션으로 제공
...
- 아이폰에서는 `카메라로 바로 촬영` 버튼을 눌러 사진 보관함 접근 없이 촬영합니다.
